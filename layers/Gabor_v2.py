...
Reference: H. T. Le, S. L. Phung, P. B. Chapple, A. Bouzerdoum, C. H. Ritz, and L. C. Tran, “Deep Gabor neural network for automatic detection of mine-like objects in sonar imagery,” IEEE Access, vol. 8, pp. 94 126–94 139, 2020.Version 2: Optimize the computations to avoid overloading CPUs
@author: Thanh Le
"""
import torch
...
class Gabor2D(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        x_kernels = np.tile(x, (out_channels, in_channels, 1, 1))
