...
# Copyright (c) 2017
# https://github.com/junfu1115/DANet/blob/56a612ec1ed5c2573ebc8df04ad08475fbf13a52/encoding/datasets/base.py#L102
###########################################################################
import random
import numpy as np
...
class BaseDataset(data.Dataset):
    def __init__(self, root='public_datasets', split='train', mode=None, transform=None,
