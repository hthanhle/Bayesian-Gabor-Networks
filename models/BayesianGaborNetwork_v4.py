...
class BayesianGaborNetwork(nn.Module):
    def __init__(self, num_inputs, num_classes, priors, activation='relu'):
        ...
        self.gabor8 = BayesianGabor2D(256, 128, 3, padding=1, priors=self.priors)
        self.act8 = self.act()

        self.gabor9 = BayesianGabor2D(256, 256, 5, padding=2, priors=self.priors)
        self.act9 = self.act()
        self.up2 = nn.Upsample(scale_factor=4, mode='bilinear', align_corners=True)
        self.gabor10 = BayesianGabor2D(256, 128, 3, padding=1, priors=self.priors)
        self.act10 = self.act()

        self.gabor11 = BayesianGabor2D(128, 256, 5, padding=2, priors=self.priors)
        self.act11 = self.act()
        self.gabor12 = BayesianGabor2D(256, 128, 3, padding=1, priors=self.priors)
        self.act12 = self.act()
