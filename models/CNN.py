...
# A CNN counterpart of BayesianGaborPFPN_config3. This aims to evaluate the model without KL, without Gabor
class CNN(nn.Module):
    def __init__(self, num_inputs, num_classes, activation_type='relu'):
        ...
        self.conv1 = nn.Conv2d(num_inputs, 32, 15, padding=7)
        self.act1 = self.act()
        self.down0 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv2 = nn.Conv2d(32, 32, 15, padding=7)
        self.act2 = self.act()
        self.down1 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv3 = nn.Conv2d(32, 32, 15, padding=7)
        self.act3 = self.act()
        ...
        self.conv11 = nn.Conv2d(32, 64, 5, padding=2)
        self.act11 = self.act()
        self.conv12 = nn.Conv2d(64, 128, 3, padding=1)
        self.act12 = self.act()

        self.up3 = nn.Upsample(scale_factor=4, mode='bilinear', align_corners=True)
        self.conv13 = nn.Conv2d(128, 32, 3, padding=1)
        self.act13 = self.act()
        self.conv14 = nn.Conv2d(32, self.num_classes, 1, padding=0)
